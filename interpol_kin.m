...
%     
%         % The value till 251 is to restrict the false detection of last 2
%         % rows as NaN. The oroblem is with Excel.
%                 
%         
%         obj = sheet_data(:,1:251);
%         obj= obj(obj(:,2)==1|obj(:,2)==2,:);
%         nan_mat = [3 4 5 6 7 28:34 35 36:39 220 221 242 243 244 245:251];
%         obj = interpolDataStatic(obj,nan_mat,[1 2]);
%         % obj{j} = sheet_data(sheet_data(:,2)==nobjs(j),:);
%         
...
%         intervalPts= [8 18 40 50 60 70 80 90 100 110 120 130 140 150 160 170 180 190 200 210 222 232];
%         interval = 10;
%         
%         obj = interpolData(obj,intervalPts,interval,[1 2]);
% 
%         
%         
%         Mobj{i} = obj;
